    ...
    <div class="jumbotron">
        <div class="container">
            ...
            @if(Session::has('errorMessage'))
                <div class="alert alert-danger" role="alert" style="width:25%;min-width: 250px">
            ...
            <form class="form-inline my-2 my-lg-0">
                ...
                <select name="active" class="form-control mr-sm-2">
                    ...
                    <option
                        value="1" {{ request()->filled('active') && request()->get('active') == 1 ? 'selected' : '' }}>
                        Yes
                    </option>
                    <option
                        value="0" {{ request()->filled('active') && request()->get('active') == 0 ? 'selected' : '' }}>
                        No
                    </option>
                </select>
                <select name="sort" class="form-control mr-sm-2">
                    ...
                    <option
                        value="latest" {{ request()->filled('sort') && request()->get('sort') == 'latest' ? 'selected' : '' }}>
                        Latest
                    </option>
                    <option
                        value="alphabetical" {{ request()->filled('sort') && request()->get('sort') == 'alphabetical' ? 'selected' : '' }}>
                        Alphabetical
                    </option>
                </select>
